...
const LearningStyleOverview = () => {
    ...
    const fetchData = async () => {
      try {
        ...
        console.log(
          ...
          response.data.learningStyleBreakdown
        ); // Debug log
  ...
  const descriptions = {
    ...
    "Concrete Examples":
      "Grounding concepts with tangible, real-world examples.",
    Interleaving: "Mixing different topics or skills during study sessions.",
    "Dual Coding":
      "Pairing visual elements with text to reinforce learning pathways.",
    "Retrieval Practice":
