...
from app.views import homepage_view,classify_chathistory, display_chathistory, percentage_chathistory, time_spent_per_topic, percentage_learning_style, taxonomy_progression

urlpatterns = [
    path('admin/', admin.site.urls),
    path('', views.homepage_view, name="homepage"),
    path('api/student/<int:pk>/', views.getStudent, name='get_student'),
    path('api/nodes/', views.getNodes, name='get_nodes'),
    path('api/relationships/', views.getRelationships, name='get_relationships'),
