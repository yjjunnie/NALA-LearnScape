  ...
  return (
    <div style={{ width: "100%", height: "100%", position: "relative" }}>
      <ThreadMapControls
        ...
        onDeleteHoverChange={setIsDeleteHovered}
        onCloseInfoTooltip={() => setShowInfoTooltip(false)}
        onConceptParentToggle={setShowConceptParentEdges}
